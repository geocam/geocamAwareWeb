...
version = geocamAware.get_version()
# The full version, including alpha/beta/rc tags.
release = geocamAware.get_version()
...
htmlhelp_basename = 'geocamAwareWebdoc'
...
latex_documents = [
  ('index', 'app.tex', u'geocamAwareWeb Documentation',
   u'Trey Smith', 'manual'),
]
